...
import IDNNs.idnns.information.information_utilities as inf_ut
from IDNNs.idnns.networks import model as mo
from IDNNs.idnns.information.mutual_info_estimation import calc_varitional_information
...
def calc_information_for_epoch(iter_index, interval_information_display, ws_iter_index, bins, unique_inverse_x,
    ...
    if calc_full_and_vartional:
        ...
        params_vartional = [
            calc_varitional_information(ws_iter_index[i], label, i, len(ws_iter_index) - 1, iter_index,
